      ...
      <div className="flex flex-col md:flex-row max-w-[1200px] mx-auto justify-between items-center relative px-4">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:w-1/2">
          ...
          <p className="mb-6 max-w-xl px-2 md:px-0 text-justify">
            Undergoing bachelor degree in Computer Applications, web developer with a passion for
            coding.Deadline-driven with strong desire to learn and contribute to team success.
            I specialize in React and front-end development, helping
            to build real-world projects and master modern web technologies.
